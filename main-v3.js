...
var tourneyLvl = 1;
var choiceANames = ["cooperate", "swerve", "macro", "fight", "bet", "raise_price", "opera", "go", "heads", "particle", "discrete", "peace", "search", "lead", "accept", "accept", "attack", "fwl", "ypq", "xt", "zw", "stt", "stt", "cxp", "dsq", "smj", "dsq", "wyy", "wf", "dxy", "bzg", "tlf", "art", "Melissa", "ypq", "Teacher Linda"]; 
var choiceBNames = ["defect", "straight", "micro", "back_down", "fold", "lower_price", "football", "stay", "tails", "wave", "continuous", "war", "evaluate", "follow", "reject", "deny", "decay", "ypq", "cdy", "sxc", "cyw", "jd", "hys", "www", "smj", "lsf", "lsf", "kj", "wff", "hb", "bzg(m)", "why", "science", "Linda", "smj", "Linda王"];
var stratCounter = 0;
var roundNum = 0;
var hMove = 1;
var vMove = 1;
...
function round(roundNum){
    ...
    if (rCounter<10){
        runRound();
        setTimeout(function(){clearGrid();}, 10);
        } else {
        currentRound++;
        runTourney();    
        }
    ...
    function clearGrid() {
        ...
        setTimeout(function(){roundLoop();}, 10);
...
function updateStats(){
    ...
    if (milestoneFlag === 15 && dismantle ==0){
        clipsElement.innerHTML = "179,769,313,486,231,590,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000";
        clipCountCrunchedElement.innerHTML = "179 uncentillion"
        }
    
    if (dismantle === 1){
        clipsElement.innerHTML = "179,769,313,486,231,590,772,930,519,078,902,473,361,797,697,894,230,657,273,430,081,157,732,675,805,500,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000";
        clipCountCrunchedElement.innerHTML = "179 uncentillion"
        }
    ...
    if (dismantle === 3){
        clipsElement.innerHTML = "179,769,313,486,231,590,772,930,519,078,902,473,361,797,697,894,230,657,273,430,081,157,732,675,805,500,963,132,708,477,322,407,536,021,120,113,879,871,393,357,658,789,768,814,416,622,492,847,430,639,474,124,377,767,893,424,865,485,276,302,219,601,246,094,119,453,082,952,085,005,768,838,150,682,342,462,881,473,913,110,540,827,237,163,350,510,684,586,298,239,947,245,938,479,716,304,835,356,329,624,224,137,116";
        clipCountCrunchedElement.innerHTML = "179 uncentillion"
        }
    ...
    if (finalClips<10){
        clipsElement.innerHTML = "179,769,313,486,231,590,772,930,519,078,902,473,361,797,697,894,230,657,273,430,081,157,732,675,805,500,963,132,708,477,322,407,536,021,120,113,879,871,393,357,658,789,768,814,416,622,492,847,430,639,474,124,377,767,893,424,865,485,276,302,219,601,246,094,119,453,082,952,085,005,768,838,150,682,342,462,881,473,913,110,540,827,237,163,350,510,684,586,298,239,947,245,938,479,716,304,835,356,329,624,224,137,"+(116+finalClips);
        clipCountCrunchedElement.innerHTML = "179 uncentillion"
        } else if (finalClips>9 && finalClips<100) {
        clipsElement.innerHTML = "179,769,313,486,231,590,772,930,519,078,902,473,361,797,697,894,230,657,273,430,081,157,732,675,805,500,963,132,708,477,322,407,536,021,120,113,879,871,393,357,658,789,768,814,416,622,492,847,430,639,474,124,377,767,893,424,865,485,276,302,219,601,246,094,119,453,082,952,085,005,768,838,150,682,342,462,881,473,913,110,540,827,237,163,350,510,684,586,298,239,947,245,938,479,716,304,835,356,329,624,224,137,"+(116+finalClips);
        clipCountCrunchedElement.innerHTML = "179 uncentillion"
        } else if (finalClips===100) {
        clipsElement.innerHTML = "Infinity";
        clipCountCrunchedElement.innerHTML = "Infinity"
        }
...
function numberCruncher(number, decimals){
    ...
    if(number>=1000000000000000000000000000000000000000000000000000000)return spellf(number);
...
function exploreUniverse(){ 
    ...
    var xRate = probeSpeed * probeNav * Math.floor(probeCount) * probeXBaseRate;
    ...
    var newRate = xRate * 100; 
        ...
        availableMatterDisplayElement.innerHTML = spellf(availableMatter);
        colonizedDisplayElement.innerHTML = (100/(Math.log(totalMatter)/Math.log(foundMatter))).toFixed(12);
}  
...
function spawnFactories(){
    ...
    unusedClipsDisplayElement.innerHTML = spellf(unusedClips);  
    if(amount>0)factoryLevel = factoryLevel + amount; factoryLevelDisplayElement
...
function spawnHarvesters(){
    ...
    unusedClipsDisplayElement.innerHTML = spellf(unusedClips);  
    if(amount>0)harvesterLevel = harvesterLevel + amount;
...
function spawnWireDrones(){
    ...
    unusedClips = unusedClips - (amount*2000000);
    unusedClipsDisplayElement.innerHTML = spellf(unusedClips);
    if(amount>0)wireDroneLevel = wireDroneLevel + amount;
